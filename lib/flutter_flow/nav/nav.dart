...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: ShopScreenWidget.routeName,
          path: ShopScreenWidget.routePath,
        ...
        FFRoute(
          name: WhyAjaWidget.routeName,
          path: WhyAjaWidget.routePath,
          builder: (context, params) => WhyAjaWidget(),
        ),
        FFRoute(
          name: AjaMottoWidget.routeName,
          path: AjaMottoWidget.routePath,
          builder: (context, params) => AjaMottoWidget(),
        ),
        FFRoute(
          name: ReturnPolicyWidget.routeName,
          path: ReturnPolicyWidget.routePath,
          builder: (context, params) => ReturnPolicyWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: DisclaimerAndImportantInformationWidget.routeName,
          path: DisclaimerAndImportantInformationWidget.routePath,
        ...
        FFRoute(
          name: OrderConfirmPageWidget.routeName,
          path: OrderConfirmPageWidget.routePath,
